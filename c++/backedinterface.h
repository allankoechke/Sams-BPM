...
private:
    ...
    int m_minBPM=72, m_maxBPM=72, m_avgBPM=72, lastSyncTime = 0, _lastSyncTime = 0, plot_index;
    ...
    QList<int> m_plotData = {79,79,48,87,94,66,63,63,56,89,55,72,87,19,88,54,38,89,98,43,36,53,79,99,95,36,64,61,78,91,84,83,39,79,63,49,69,43,79};
};
